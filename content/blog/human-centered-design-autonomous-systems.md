---
title: "Human-Centered Design in the Age of Autonomous Systems"
date: 2025-05-05
description: "Traditional UX principles were built around a human operating an interface. What happens when the interface itself is an agent?"
author: "Editorial"
tags: ["ux", "design", "human-computer-interaction"]
categories: ["Design"]
featured: true
---
...
Agentic systems dissolve that membrane. An agent given a goal can execute hundreds of sub-actions without ever surfacing a decision to the human. This is precisely what makes them powerful—and precisely what makes the design challenge so interesting.

The inversion is this: instead of designing an interface for a human to control a machine, we're designing systems where a machine controls a *workflow*, and the human's job is to set direction, provide judgment at key moments, and course-correct.

## Principles for Agentic UX

Based on early experience deploying these systems, we're developing a working set of principles:

**1. Make agency legible.** Humans need to understand what an agent is doing and why. Invisible agents erode trust. Show the work.
...
**4. Account for mistakes.** Agents will err. Design for recovery, not just for success. Make it easy to understand what went wrong and undo it.
...
These principles aren't final—they're hypotheses to be tested. That's part of what this publication is for.
